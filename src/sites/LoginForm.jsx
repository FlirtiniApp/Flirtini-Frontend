  ...
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center">
      <form
        ...
        className="bg-gray-800 text-gray-100 rounded-xl p-6 shadow-lg max-w-md w-full gap-y-6 flex flex-col items-center"
        style={{ minHeight: "400px" }}
      >
        <div className="text-center">
          <p className="text-3xl font-semibold mb-2">
            Welcome to{" "}
            <span className="font-[Dancing_Script] text-5xl">Flirtini</span>
          </p>
        ...
        <div className="mt-4 text-gray-400 text-center text-sm font-light">
          Not a member?{" "}
